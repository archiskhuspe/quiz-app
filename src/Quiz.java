...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String username) {
        ...
        count = 0; score = 0; timer = 15; ans_given = 0;
        setBounds(250, 50, 1440, 950);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("images/quiz_1.jpg"));
    ...
    public void paint(Graphics g) {
        ...
        if (timer >= 0) {
            g.drawString(time, 1115, 500);
        } else {
            g.drawString("Time's Up!", 1115, 500);
        }
